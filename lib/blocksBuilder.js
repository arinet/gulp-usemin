      ...
      if (section[1] !== 'remove') {
        if (jsReg.test(section[5])) {
          blocks.push({
            ...
            name: options.jsBundlePath ? outputPath + options.jsBundlePath : outputPath + section[4],
          ...
          blocks.push({
            ...
            nameInHTML: section[3],
            name: options.cssBundlePath ? outputPath + options.cssBundlePath: outputPath + section[4],
